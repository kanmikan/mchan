...
function randomNoCom(){
	let frases = [
		"No hay comentarios, dejá uno ike ike!",
		...
		"No hay comentarios ni mikans acá...",
...
module.exports = {randomNoCom, isTagOp, isDataImage, seclink, isGif, isImg, isVideo, clone, getCategoryData, filterComMedia, getCatShow, timeSince, formatBytes, getPollPercent, genCID, uuidv4, randomString, parseCookies, genColor, xmur3, weightRandom};