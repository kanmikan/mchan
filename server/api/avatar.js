...
function pickCSSAnon(){
	return utils.weightRandom([
		...
		["ico,#ff5722,#ffffff, ,ANON, ", P[3]], //naranja
...
function pickMikanon(){
	let randomMikan = Math.floor(Math.random() * 9);
	return utils.weightRandom([
		["ico,#ff5722,#ffffff, ", 90],
		["ico,#ffffff,#ff5722, ", 90],
		["/assets/anon/mikan/chika" + randomMikan + ".png", 90],
		["/assets/anon/mikan/chika10.png", 90],
		["/assets/anon/mikan/chika11.png", 90],
		["/assets/anon/mikan/chika12.png", 90]
	]);
}

//aniversario
function pickAniversary(){
	return utils.weightRandom([
		["ico,#ff5722,#ffffff,hitem mikanbadge1", 1],
		["ico,#ffffff,#ff5722,hitem mikanbadge1", 1],
		["ico,#FFcc00,#ffffff,hitem mikanbadge1", 1], //amarillo
		["ico,#0579b3,#ffffff,hitem mikanbadge1", 1], //azul
		["ico,#02b13c,#ffffff,hitem mikanbadge1", 1], //verde
		["ico,#df0202,#ffffff,hitem mikanbadge1", 1], //rojo
		["class,anonMultiMikan,mikan,", 0.1]
	]);
}
